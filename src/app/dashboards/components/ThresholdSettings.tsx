...
export default function ThresholdSettings() {
  ...
  const handleThresholdChange = (index: number, updates: Partial<ScopeThreshold>) => {
  ...
  const handleSaveChanges = async () => {
    try {
      // Send all thresholds in a single request
    ...
    <Sheet>
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>
            Set custom thresholds for each emission scope to receive alerts when exceeded.
          </SheetDescription>
        </SheetHeader>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleThresholdChange(index, { value: Number(e.target.value) })
                    }
